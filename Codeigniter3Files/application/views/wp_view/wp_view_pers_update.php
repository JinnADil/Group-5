...
<div class="container my-5 bg-light">
	...
	<form method="post" action="<?php echo base_url()?>wp_controller/register">
			...
			<label class="label col-md-4 control label">Receiving Email Address:</label>
    					<div class="col-lg-8 mb-3">
    					<input type="text" name="rec_email" value="<?php echo $user['sender_docu_email']?>"  class="form-control" placeholder="Email Address" aria-label="Recieving Email Address">
		...
		<div>
					...
					<div class="d-grid gap-1 d-md-flex justify-content-md-end">
						...
						<input class="btn-lg btn-primary m-4" type="submit" value="Update" name="pers_update">
        			</div>
